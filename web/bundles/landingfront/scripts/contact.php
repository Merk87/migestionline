...
// Please Note, we cannot support this file package if modifications have been made below this line.
	...
	$error = '';
		...
		if($error != '') {
			echo '<div class="alert alert-error"><strong>Attention!</strong> Please correct the errors below and try again.';
			echo '<button class="close" data-dismiss="alert">×</button>';
			echo '<ul class="error-messages">' . $error . '</ul>';
			echo '</div>';
		...
		if(get_magic_quotes_gpc()) { $comments = stripslashes($comments); }
		 ...
		 $msg  = "You have been contacted by $name, they passed verification and their message is as follows." . PHP_EOL . PHP_EOL;
		...
		if(mail($address, $e_subject, $msg, $headers)) {
		 ...
		 echo "<div id='success-page' class='alert alert-success'>";
